...
export class CompareComponent implements OnInit {
    ...
    if (this.mymap.has(input)) {
      ...
      if (this.mymap.get(input).crimedata.length == 0) {
        ...
        .subscribe(resInputData =>  {
          ...
          this.renderGraph(this.crimelocations1, this.labels1)
        })
      } else {
    ...
    if (this.mymap.has(input)) {
      ...
      if (this.mymap.get(input).crimedata.length == 0) {
        ...
        .subscribe(resInputData =>  {
          ...
          console.log("Not seen yet")
          this.renderGraph(this.crimelocations2, this.labels2);
          this.changeChart();
        })
      } else {
  ...
  renderGraph(crimes: Array<Location>, labels: Array<string>) {
